...
import com.devsuperior.dsclient.services.MyEntityNotFoundException;

@ControllerAdvice //Responsável por tratar a excessão que ocorre no controlador
public class ResourceExceptionHandler {
	
	@ExceptionHandler(MyEntityNotFoundException.class) // diz que se no controlador ocorrer algum erro do tipo EntityNotFoundException, o erro será destina para o método abaixo
	public ResponseEntity<StandardError> clientNotFound(MyEntityNotFoundException e, HttpServletRequest request){ //o conteúdo da resposta vai ser um tipo StandardError
